      ...
      <div className="flex flex-wrap">
        <div className="w-full lg:w-1/2">
          <div className="flex flex-col items-center lg:items-start">
            <h1 className="bg-gradient-to-r from-purple-400 via-indigo-400 to-purple-500 bg-clip-text pb-4 text-6xl font-medium tracking-tight text-transparent max-[450px]:text-4xl max-[450px]:font-black md:text-7xl lg:mt-16">
              Bishoy Gamal
            </h1>
